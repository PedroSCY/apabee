...
import { IInsumoRepository, ILiberarInsumoManutencaoUseCase, Insumo } from '@apa/core'
import { INSUMO_REPOSITORY } from '../../patrimonio.tokens'

@Injectable()
export class LiberarInsumoManutencaoUseCase implements ILiberarInsumoManutencaoUseCase {
  constructor(
  ...
  async execute(id: string): Promise<Insumo> {
    ...
    return this.insumoRepository.update(insumo.marcarDisponivel())
  }
}
