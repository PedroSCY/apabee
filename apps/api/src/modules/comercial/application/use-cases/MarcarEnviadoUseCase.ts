...
import { IMarcarEnviadoUseCase, IPedidoRepository, Pedido } from '@apa/core'
import { PEDIDO_REPOSITORY } from '../../comercial.tokens'

@Injectable()
export class MarcarEnviadoUseCase implements IMarcarEnviadoUseCase {
  constructor(
  ...
  async execute(pedidoId: string): Promise<Pedido> {
    ...
    return this.pedidoRepo.update(pedido.marcarEnviado())
  }
}
