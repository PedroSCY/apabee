...
export class PrismaContribuicaoRepository implements IContribuicaoRepository {
  ...
  private toData(c: Contribuicao) {
    return {
      ...
      tipoMateriaPrimaId: c.tipoMateriaPrimaId ?? null, horas: c.horas ?? null,
      regraCalculo: c.regraCalculo ?? null, regraParametro: c.regraParametro ?? null,
  ...
  private toDomain(r: any): Contribuicao {
    return new Contribuicao({
      ...
      tipoMateriaPrimaId: r.tipoMateriaPrimaId ?? undefined, horas: r.horas ? Number(r.horas) : undefined,
      regraCalculo: r.regraCalculo as RegraAcordo ?? undefined, regraParametro: r.regraParametro ? Number(r.regraParametro) : undefined,
